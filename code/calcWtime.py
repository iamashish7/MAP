...
kmeans = joblib.load('/var/www/html/new/code/predict_models/Kmeans.pkl')  

reg_models = []
for i in range(6):
    reg_models.append(joblib.load('/var/www/html/new/code/predict_models/Log_reg'+str(i)+'.pkl'))
